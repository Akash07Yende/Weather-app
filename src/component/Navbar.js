  ...
  <div class="container-fluid rounded-end">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav mx-auto p-2">
        ...
        <li class="nav-item px-3">
          <a class="nav-link btn" href='#' onClick={() => alert('Open Weather API')}>About</a>
        </li>
        <li class="nav-item px-3 ">
          <a class="nav-link btn" href='#' onClick={() => alert(`Akash Yende (Web Developer)\nEmail : akashyende1206@gmail.com`)}>Contact</a>
        </li>
